...
def show_persistent_header():
    ...
    print(f"\033[1;35m  Audio:\033[0m {PERSISTENT_PORTS['audio_device']} (Input/Output) | \033[1;35mPTT:\033[0m CAT")
    print("\033[1;32m" + "="*80 + "\033[0m")  # Green header line
    print()
    ...
    try:
        ...
        # Frequency commands
            ...
            if len(cmd_str) > 2:
                ...
                return f'FA{freq};'.encode('utf-8')  # Echo back with proper format
            else:
            ...
            if len(cmd_str) > 2:
                ...
                return f'FB{freq};'.encode('utf-8')  # Echo back with proper format
            else:
        ...
        # PTT operations
            ...
            return cmd  # Echo back TX command
        elif cmd_str == 'RX':
            return b'RX;'  # Echo back RX command
